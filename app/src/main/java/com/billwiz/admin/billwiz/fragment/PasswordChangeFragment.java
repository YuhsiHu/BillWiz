...
public class PasswordChangeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        BillWizFragmentManager.passwordChangeFragment[fragmentPosition] = this ;
        ...
        passwordTip.setTypeface(BillWizUtil.GetTypeface());
        switch (fragmentPosition) {
            case 0:
                if (com.billwiz.admin.billwiz.model.SettingManager.getInstance().getFirstTime()) {
                    passwordTip.setText(BillWizApplication.getAppContext().getResources()
