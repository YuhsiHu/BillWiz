...
import com.billwiz.admin.billwiz.ui.FixedSpeedScroller;
        ...
        switch (CURRENT_STATE) {
            case VERIFY_STATE:
                if (BillWizUtil.ClickButtonDelete(position)) {
                    ...
                    oldPassword += BillWizUtil.BUTTONS[position];
...
//                superToast.getTextView().setTypeface(BillWizUtil.typefaceLatoLight);
                Toasty.error(mContext,mContext.getResources().getString(R.string.toast_password_wrong));
...
//                superToast.setBackground(SuperToast.Background.RED);
//                superToast.getTextView().setTypeface(BillWizUtil.typefaceLatoLight);
                Toasty.warning(mContext,mContext.getResources().getString(R.string.different_password));
                break;
            // success
            case 2:
...
//                superToast.getTextView().setTypeface(BillWizUtil.typefaceLatoLight);
                Toasty.success(mContext,mContext.getResources().getString(R.string.set_password_successfully));
                break;
            default:
                break;
        }
