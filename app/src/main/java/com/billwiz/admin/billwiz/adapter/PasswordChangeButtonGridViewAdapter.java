...
public class PasswordChangeButtonGridViewAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.fl.setBackgroundColor(
                BillWizUtil.getAlphaColor(com.billwiz.admin.billwiz.model.SettingManager.getInstance().getRemindColor()));
        holder.ml.setRippleColor(com.billwiz.admin.billwiz.model.SettingManager.getInstance().getRemindColor());
        holder.iv.setColor(com.billwiz.admin.billwiz.model.SettingManager.getInstance().getRemindColor());
        holder.tv.setTextColor(com.billwiz.admin.billwiz.model.SettingManager.getInstance().getRemindColor());
