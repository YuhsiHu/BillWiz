...
public class TagDraggableItemAdapter
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.tagImage.setImageResource(BillWizUtil.GetTagIcon(tags.get(position).getId()));
        holder.tagName.setText(BillWizUtil.GetTagName(tags.get(position).getId()));
        ...
        if (((dragState & Draggable.STATE_FLAG_IS_UPDATED) != 0)) {
            ...
            if ((dragState & Draggable.STATE_FLAG_IS_ACTIVE) != 0) {
                ...
                BillWizUtil.clearState(holder.mContainer.getForeground());
