package com.billwiz.admin.billwiz.ui.animation;
...
import com.billwiz.admin.billwiz.ui.util.ActionBarInterpolator;
import com.billwiz.admin.billwiz.ui.util.GuillotineInterpolator;
...
public class GuillotineAnimation {
    ...
    public static class GuillotineBuilder {
        ...
        public com.billwiz.admin.billwiz.ui.animation.GuillotineAnimation build() {
            return new com.billwiz.admin.billwiz.ui.animation.GuillotineAnimation(this);
        }
    }
}
