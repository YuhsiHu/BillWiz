...
public class SplashActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appName.setTypeface(BillWizUtil.getInstance().typefaceLatoLight);
        loadingText = (TextView)findViewById(R.id.loading_text);
        loadingText.setTypeface(BillWizUtil.getInstance().typefaceLatoLight);
    ...
    private void startCircularReveal() {
        ...
        int cx = location[0] + BillWizUtil.dpToPx(24);
        int cy = location[1] + BillWizUtil.dpToPx(24);
        ...
        animator.addListener(new SupportAnimator.AnimatorListener() {
            ...
            public void onAnimationEnd() {
                Log.d("BillWiz", "Showing animation completed");
    ...
    public class InitData extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            Looper.prepare();
            Bmob.initialize(BillWizApplication.getAppContext(), BillWiz.APPLICATION_ID);
            CrashReport.initCrashReport(BillWizApplication.getAppContext(), "900018935", false);
            RecordManager.getInstance(BillWizApplication.getAppContext());
            BillWizUtil.init(BillWizApplication.getAppContext());
            return null;
        }
        @Override
        protected void onPostExecute(String result) {
            Log.d("BillWiz", "Loading Data completed");
