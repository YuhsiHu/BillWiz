...
// default value////////////////////////////////////////////////////////////////////////////////////
    ...
    private final String DEFAULT_ACCOUNT_BOOK_NAME = "BillWiz";
    // the password
    ...
    public Boolean getFirstTime() {
        FIRST_TIME = PreferenceManager.
                getDefaultSharedPreferences(BillWizApplication.getAppContext())
    ...
    public void setFirstTime(Boolean FIRST_TIME) {
        SharedPreferences.Editor editor = PreferenceManager
                .getDefaultSharedPreferences(BillWizApplication.getAppContext()).edit();
